...
function Admin() {
    ...
    return (
        ...
        <div className='max-w-screen-2xl  container mx-auto md:px-20 px-4'>
            ...
            <button onClick={() => document.getElementById('my_modal_5').showModal()} className=' w-full rounded-2xl my-5 btn btn-secondary text-xl md:w-1/3 shadow-xl shadow-pink-300 '>Add Book</button>
            <AddBook />
